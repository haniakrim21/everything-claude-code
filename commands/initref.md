---
description: "Build a reference for the project implementation details, writing markdown documentation files to /ref and updating CLAUDE.md with pointers to them."
---
