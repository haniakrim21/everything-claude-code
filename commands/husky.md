---
description: "Verify the repository is in a working state by running lint, type checks, tests, and package validation, fixing issues and staging files for commit."
---
