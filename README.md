...
**196 agents** &middot; **1,046 skills** &middot; **89 commands** &middot; **29 rules** &middot; **22 hooks**
...
| **Skills** | 1,035 | Reusable workflow knowledge — TDD, security, patterns, frameworks, automation |
...
CI validators also check all 196 agents, 89 commands, 1,035 skills, and 29 rules for valid frontmatter and structure.
